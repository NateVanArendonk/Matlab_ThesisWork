function out = COOPS_tides_get(station,dates,interval)
...
%% read data
url = ['https://tidesandcurrents.noaa.gov/api/datagetter?product=water_level&application=NOS.COOPS.TAC.MET&begin_date=',bdate,...
   '&end_date=',edate,'&station=',station,'&time_zone=',timezone,'&units=',unit,'&interval=',int,'&format=json'];

%product=predictions&application=NOS.COOPS.TAC.WL&begin_date=20170808&end_date=20170815&datum=NAVD&station=9443090&time_zone=GMT&units=metric&interval=&format=json
