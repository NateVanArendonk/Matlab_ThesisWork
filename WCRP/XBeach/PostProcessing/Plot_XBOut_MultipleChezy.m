...
path = '../OB_Runs/RoughnessTesting/chezy/';
grid_path = '../Owen_Beach_XbeachGrids/';
filename = '/xboutput.nc';

xbr = dir('../OB_Runs/RoughnessTesting/chezy/*');
xbr(1:2) = []; % Gets rid of 2 weird results 

xb_info = ncinfo([path 'r50/' filename]); % Just get info from on eof the runs 
...
printFig(gcf,'ChezyRoughnessTesting',[15 11],'png',300)
