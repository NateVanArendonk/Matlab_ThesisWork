function showRunupsOnStackNoBackground(x, t, I, runups)
%   showRunupsOnStackNoBackground(x, t, I, runups)
%
%  Plot a runup stack with runup and picks.  In this case the stack has the
%  background intensity transect removed.
...
for i = 1: NPanels
    ...
    imagesc(x,dn(inds),I(inds,:)); datetick('y')
